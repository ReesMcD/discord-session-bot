/**
 * npm run import:craig -- <craig-export.zip | extracted folder> [--no-transcribe]
 *
...
if (!input || input.startsWith('--')) die('Usage: npm run import:craig -- <craig-export.zip | folder> [--no-transcribe]');
